        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-border/10">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-medium text-[#181717]">Edit Project</h1>
                <p className="text-[15px] text-[#666666] mt-1">Update the details of your project.</p>
              </div>
            </div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          <Input {...field} type="date" className="appearance-none" />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
